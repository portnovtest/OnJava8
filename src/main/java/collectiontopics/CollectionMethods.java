...
public class CollectionMethods {
    public static void main(String[] args) {
        List<String> c = new ArrayList<>(LIST.subList(0, 4));
        c.add("ten");
        c.add("eleven");
        show(c);
        border();
        ...
        // this means different things depending on the way the Comparable interface is implemented:
        ...
        Collection<String> c3 = c.subList(3, 5);
