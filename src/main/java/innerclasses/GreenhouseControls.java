...
// This produces a specific application of the control system, all in a single class. Inner classes
// allow you to encapsulate different functionality for each type of event.
