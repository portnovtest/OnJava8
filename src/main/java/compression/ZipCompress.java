...
public class ZipCompress {
    public static void main(String[] args) {
        try (FileOutputStream f = new FileOutputStream("src/main/java/compression/test.zip");
        ...
        try (FileInputStream fi = new FileInputStream("src/main/java/compression/test.zip");
        ...
        try (ZipFile zf = new ZipFile("src/main/java/compression/test.zip")) {
