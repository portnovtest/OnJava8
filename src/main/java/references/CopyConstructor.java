...
// A constructor to copy an object of the same type, as an attempt to create a local copy
...
class Fruit {
    ...
    // This allows derived constructors (or other methods) to put in different qualities:
